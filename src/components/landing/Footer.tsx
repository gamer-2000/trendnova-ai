      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="https://discord.gg/P36rMNgnZV" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-[#5865F2] transition-colors flex items-center gap-1">Join Discord</a>
